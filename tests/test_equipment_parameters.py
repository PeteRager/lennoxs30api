...
def test_equipment_parameter():
    ...
    assert par.pid == 11
    assert par.name == None
    assert par.defaultValue == None
    assert par.descriptor == None
    assert par.enabled == None
    assert par.format == None
    assert par.value == None
    assert len(par.radio) == 0
    assert par.range_min == None
    assert par.range_max == None
    assert par.range_inc == None
    assert par.string_max == None
    assert par.unit == None
...
def test_equipment_parameters_validate_and_translate_radio(api):
    ...
    parameter.validate_and_translate("Display Only") == 0
    parameter.validate_and_translate("Basic") == 1
    parameter.validate_and_translate("Precision") == 2
...
def test_equipment_parameters_validate_and_translate_range(api):
    ...
    parameter.validate_and_translate("10") == "10"
    parameter.validate_and_translate("1.5") == "1.5"
    parameter.validate_and_translate("2.0") == "2.0"
    parameter.validate_and_translate("2.5") == "2.5"
