...
async def test_set_zone_test_parameter_value(api_system_04_furn_ac_zoning):
    ...
    with patch.object(system, "_internal_set_zone_test_parameter_value") as _internal_set_zone_test_parameter_value:
        ...
        assert _internal_set_zone_test_parameter_value.call_args[0][0] == PID_ZONE_1_BLOWER_CFM
